...
const PostanovlenieOtopitelnyyPeriodKonec = () => {
  ...
  return (
    <article>
         <div>
      <h2 className='news_header'> ПОСТАНОВЛЕНИЕ ОБ ОКОНЧАНИИ ОТОПИТЕЛЬНОГО ПЕРИОДА 2024-2025 ГГ.</h2>
      <div className='news_content'>
        <NavigationButtons prevNewsIndex={prevNewsIndex} nextNewsIndex={nextNewsIndex} />
       <p>Опубликовано {currentNews.date}</p>
       <a href="/news/Otopitelnyy period okonchanie 24-25-2.pdf" target="_blank" rel="noopener noreferrer">Скачать Постановление</a>
      </div>
    </div> 
    </article>
...
export default PostanovlenieOtopitelnyyPeriodKonec;