...
<div className='useful_phones'>
 ...
 <div>
    <p className='text_contacts'>Аварийно-диспетчерская служба филиала МУП "МЩВ «Водоканал Пушкинского г.о.»</p>
...
<div className='useful_phones'>
   <img src={phone} width="50px" height="50px"  alt="phone number"/>
   <div>
      <p className='text_contacts'>Аварийно-диспетчерская служба Пушкинского филиала ООО «Газпром теплоэнерго МО»</p>
...
<div className='useful_phones'>
   <img src={phone} width="50px" height="50px"  alt="phone number"/>
   <div>
     <p className='text_contacts'>Аварийно-диспетчерская служба Северных сетей МОЭсК</p>
...
<div className='useful_phones'>
   <img src={phone} width="50px" height="50px"  alt="phone number"/>
   <div>
     <p className='text_contacts'>Центральная аварийно-диспетчерская служба</p>
...
<div className='useful_phones'>
   <img src={phone} width="50px" height="50px"  alt="phone number"/>
   <div>
     <p className='text_contacts'>МЧС</p>
...
<div className='useful_phones'>
   <img src={phone} width="50px" height="50px"  alt="phone number"/>
   <div>
     <p className='text_contacts'>Служба газового хозяйства</p>
