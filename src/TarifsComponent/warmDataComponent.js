...
const WarmDataComponent = ({ warmData }) => {
    return (
        ...
        <div className='tarifs_data_box_headers'>
         ...
         <h3>Вид услуги</h3>
         <div>
             <h3>Тарифы на 2024г. (руб./Гкал) с учетом НДС 20%</h3> 
            ...
            <p className='normativ'>*Распоряжение Комитета по ценам и тарифам МО от 20.12.2023 г. №303-Р</p>
            <p className='normativ'>**Распоряжение Комитета по ценам и тарифам МО от 20.12.2023 г. №317-Р</p>
        </div>
    );
};
